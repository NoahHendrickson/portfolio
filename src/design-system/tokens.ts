...
export const type = {
  ...
  'body-l': { fontSize: '16px', fontWeight: 400, lineHeight: 1.6, letterSpacing: '-0.01em' },
  'body-m': { fontSize: '15px', fontWeight: 400, lineHeight: 1.5, letterSpacing: '0' },
  'body-s': { fontSize: '14px', fontWeight: 400, lineHeight: 1.5, letterSpacing: '0' },
